...
import { GET_TS_CUTOFFS_2025_BY_RANK } from "../graphql/queries";
...
import { phaseOptions } from "../data/phase";
...
const Cutoff2025 = () => {
    ...
    if (
      ...
      const variables = {
        filter: {
          ...
          instituteName: selectedInstitutes,
  ...
  useEffect(() => {
    if (data?.tsCutoff2025ByRank) {
      setResult(data.tsCutoff2025ByRank);
    }
  }, [data]);
    ...
    <section className="bg-gray-50 flex justify-center items-center flex-col overflow-x-auto py-2 sm:py-4 sm:px-8 text-[6px] sm:text-[12px] font-sans">
                  ...
                  <div className="flex flex-col items-start gap-3 max-h-24 overflow-y-auto pr-2">
                    ...
                    >
                      <input
                        ...
                        checked={
                          selectedInstitutes.length === instituteOptions.length
                        }
                        onChange={() => {
                          if (
                            selectedInstitutes.length ===
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setSelectedInstitutes((prevState) =>
                              checked
                                ? [...prevState, value]
                                : prevState.filter((ins) => ins !== value),
                            );
                          }}
                        />
                      ...
                      <input
                        ...
                        onChange={() => {
                          if (
                            ...
                            // Select all
                            setSelectedCastes(
                              casteOptions2025.map((opt) => opt.value),
                            );
                          }
                        }}
                      />
      ...
      <article className="w-full h-full mt-20">
        ...
        <div className="mt-8">
          ...
          {data?.tsCutoff2025ByRank?.length === 0 && (
